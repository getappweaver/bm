...
type SearchPrevCommandProps = {
  cmd: HandleBmCommandProps;
  pageOptions: SearchPageOptions;
};

export function handleSearchPrevCommand(
  props: SearchPrevCommandProps,
): SearchCommandResult {
  ...
  return {
    ...
    text: getSearchSessionPage(updatedSession, prevPage, pageOptions),
  };
}
